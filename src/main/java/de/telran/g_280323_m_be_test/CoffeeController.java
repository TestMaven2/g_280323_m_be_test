...
//                                будет отзываться наш контроллер
// http://localhost:8080/user   - на запросы, отправленные на эти адреса,
//                                контроллер отвечать не будет
...
public class CoffeeController {
    ...
    public CoffeeController() {
        ...
        coffeeList.add(new Coffee(3, "Mocha"));
    }
    ...
    // POST -> http://localhost:8080/coffee/
